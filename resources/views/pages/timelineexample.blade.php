...
@section('content-header')
      <h1>
        Timeline Example
        <small><a href="https://jsganttimproved.github.io/jsgantt-improved/">JsGantt Improved</a></small>
      </h1>
      <ol class="breadcrumb">
...
@push('scripts')
    ...
    <script type="text/javascript">
		...
		//	 							   	pID, 	pName, 					pStart, 	pEnd, 			pColor, 		pLink, pMile, pRes, pComp, pGroup, pParent, pOpen, pDepend, pCaption, pNotes, pGantt
			...
			g.AddTaskItem(new JSGantt.TaskItem(2,   'DelProsjekt 2',     '',           '',          'ggroupblack',  '',       0, 'Brian',    0,   1, 0,  1, '',      '',      'Some Notes text', g ));
			g.AddTaskItem(new JSGantt.TaskItem(3,   'DelProsjekt 3',     '',           '',          'ggroupblack',  '',       0, 'Brian',    0,   1, 0,  1, '',      '',      'Some Notes text', g ));
																																			//	 ! pGroup
