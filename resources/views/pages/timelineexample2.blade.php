...
@push('styles')
	...
	<link rel=stylesheet href="/twgantt/platform.css" type="text/css">
	<link rel=stylesheet href="/twgantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">

	<link rel=stylesheet href="/twgantt/gantt.css" type="text/css">
	<link rel=stylesheet href="/twgantt/ganttPrint.css" type="text/css" media="print">
...
@push('scripts')
	...
	<script src="/twgantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
	<script src="/twgantt/libs/jquery/jquery.timers.js"></script>

	<script src="/twgantt/libs/utilities.js"></script>
	<script src="/twgantt/libs/forms.js"></script>
	<script src="/twgantt/libs/date.js"></script>
	<script src="/twgantt/libs/dialogs.js"></script>
	<script src="/twgantt/libs/layout.js"></script>
	<script src="/twgantt/libs/i18nJs.js"></script>
	<script src="/twgantt/libs/jquery/dateField/jquery.dateField.js"></script>
	<script src="/twgantt/libs/jquery/JST/jquery.JST.js"></script>

	<script type="text/javascript" src="/twgantt/libs/jquery/svg/jquery.svg.min.js"></script>
	<script type="text/javascript" src="/twgantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


	<script src="/twgantt/ganttUtilities.js"></script>
	<script src="/twgantt/ganttTask.js"></script>
	<script src="/twgantt/ganttDrawerSVG.js"></script>
	<script src="/twgantt/ganttGridEditor.js"></script>
	<script src="/twgantt/ganttMaster.js"></script>
