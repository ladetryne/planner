...
Route::middleware('auth:api')->get('/getProject', function (Request $request) {
    return json_encode('{"tasks":    [
          {"id": -1, "name": "Gantt editor1", "progress": 0, "progressByWorklog": false, "relevance": 0, "type": "", "typeId": "", "description": "", "code": "", "level": 0, "status": "STATUS_ACTIVE", "depends": "", "canWrite": true, "start": 1396994400000, "duration": 20, "end": 1399586399999, "startIsMilestone": false, "endIsMilestone": false, "collapsed": false, "assigs": [], "hasChild": true},
...
Route::middleware('auth:api')->get('/saveProject', function (Request $request) {
    return response(200);
});
